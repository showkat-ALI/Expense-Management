...
const AdvanceRules = () => {
  ...
  const handleAmount = (e) => {
    advance.rules[0].amountLimit = e.target.value;
  };

  const handleOccurrence = (e) => {
    advance.rules[0].occurrenceLimit = e.target.value;
  };

  const handleRequireDescription = () => {
    setIsRequireDescription(!isRequireDescription);
    advance.rules[0].requireDescription = isRequireDescription;
  };
