...
const SingleCategoryDetail = (props) => {
    const myLoader = ({ src, width }) => {
        return `${src}?w=${width}`;
    }
    const { id, que, ans } = props.faq;
    const [click, setClick] = useState(false)
    return (
        <div className=" ">
            <div className="bg-[#FFFFFF] h-[70px] md:w-[500px] w-[350px] rounded-2xl pt-2 pb-2 pl-2 pr-[24px] mb-[10px] mx-auto">
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <div className="w-[54px] h-[54px] bg-[#4D49FF] rounded-2xl py-[17px] px-[16px] mr-[16px]">
                            <Image loader={myLoader} alt="" width="20px" height="20px" src="/images/qicon.png"></Image>
                        </div>
